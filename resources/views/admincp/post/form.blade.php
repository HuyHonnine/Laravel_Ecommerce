            ...
            <div class="col-md-12">
                <div class="">
                        ...
                        <div class="col-md-3">
                            <div class="box box-primary px-10 py-4">
                                @if (Auth::user()->can('public post'))
                                    ...
                                    <div class="form-group row">
                                        {!! Form::label('post_hot', 'Bài Viết Nổi Bật', []) !!}
                                        {!! Form::select('post_hot', ['0' => 'Không', '1' => 'HOT'], isset($post) ? $post->status : '', [
                                            'class' => 'form-control h-100 cursor-pointer font-semibold',
                                        ]) !!}
                                    </div>
                                @else
                                    ...
                                    @else
                                        <div class="form-group row">
                                            {!! Form::label('status', 'Trạng Thái', []) !!}
                                            {!! Form::select('status', ['1' => 'Đã Duyệt'], isset($post) ? $post->status : '', [
                                                'class' => 'form-control h-100 cursor-pointer font-semibold text-green-500',
                                                'readonly',
                                            ]) !!}
                                        </div>
                                    @endif
                                    {!! Form::hidden('post_hot', 0) !!}
                    ...
                    <div class="box-footer">
                        @if (!isset($post))
                            {!! Form::submit('Lưu Bài Viết', ['class' => 'btn btn-success bg-green-600']) !!}
                        @else
